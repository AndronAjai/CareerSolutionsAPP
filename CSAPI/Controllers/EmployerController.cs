...
namespace CSAPI.Controllers
{
    ...
    public class EmployerController : ControllerBase
    {
        ...
        public EmployerController(IEmployerRepo employerRepo, IApplicationRepo applicationRepo)
        {
        ...
        // GET: api/Employers
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EmployerController>>> ShowAll()
        {
        ...
        // GET: api/Employers/5
        [HttpGet("{id}")]
        public async Task<ActionResult<EmployerController>> FindEmployer(int id)
        {
