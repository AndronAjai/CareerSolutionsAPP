...
namespace CSAPI.Migrations
{
    ...
    [Migration("20240820130729_CareerSolutionsDataBase")]
    partial class CareerSolutionsDataBase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbCreationApp.Models.Application", b =>
                {
            ...
            modelBuilder.Entity("DbCreationApp.Models.BranchOffice", b =>
                {
            ...
            modelBuilder.Entity("DbCreationApp.Models.Employer", b =>
                {
            ...
            modelBuilder.Entity("DbCreationApp.Models.Job", b =>
                {
                    b.Property<int>("JobID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbCreationApp.Models.JobSeeker", b =>
                {
                    b.Property<int>("JobSeekerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbCreationApp.Models.User", b =>
                {
                    b.Property<int>("UserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbCreationApp.Models.Application", b =>
                {
                    b.HasOne("DbCreationApp.Models.Job", null)
                        .WithMany()
                        .HasForeignKey("JobID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DbCreationApp.Models.JobSeeker", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DbCreationApp.Models.Job", b =>
                {
                    b.HasOne("DbCreationApp.Models.Employer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DbCreationApp.Models.User", b =>
                {
                    b.HasOne("DbCreationApp.Models.BranchOffice", null)
                        .WithMany()
                    ...
                    b.HasOne("DbCreationApp.Models.Employer", null)
                        .WithOne()
                        .HasForeignKey("DbCreationApp.Models.User", "UserID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
